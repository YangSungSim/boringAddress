package com.example.lazyaddress.controller;

import com.example.lazyaddress.domain.Address;
import com.example.lazyaddress.domain.AddressForm;
import com.example.lazyaddress.service.AddressService;
...
public class AddressController {
    ...
    public String findOne(@RequestParam String name,
        ...
        if (friendName.trim().length() >= 1) {
            Address addressOne = addressService.findByName(friendName);
